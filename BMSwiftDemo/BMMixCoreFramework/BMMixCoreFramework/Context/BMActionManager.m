...
//#import <BMMixCoreFramework-Swift.h>

#import <BMMixCoreFramework/BMMixCoreFramework-Swift.h>
...
-(void)excute:(NSMutableDictionary*)dicparam
{
    ...
    if (!idObject) {
        ...
        if (!idObject) {
            ...
            BMActionManagerSwift *bmactionmanagerswift = [BMActionManagerSwift shareInstance];
            
            [bmactionmanagerswift excute:dicparam];
