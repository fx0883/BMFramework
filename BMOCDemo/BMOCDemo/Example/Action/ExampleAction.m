...
-(void)login:(BMBaseParam*)baseParam
{
    //    NSString *strSoapMsg=@"<?xml version=\"1.0\" encoding=\"utf-8\"?>"
    //    "<soap12:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\""
    //    "xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap12=\"http://www.w3.org/2003/05/soap-envelope\">"
    ...
    NSString *strUrl = @"UserInfoWebService.asmx";
    
    NSString *strMethod = @"POST";
    
    NSDictionary *dicParam = @{@"phone":@"1234568",@"passWord":@"123456"};
    
    NSMutableURLRequest *request = [AFAppSoapClient createUrlRequest2:dicParam invokemethod:@"OnLogin" urlString:strUrl];
    AFHTTPRequestOperationManager *manager=[AFAppSoapClient sharedSoapManager];
